...
public class Main {
    ...
    private void newFilmWasMade() {
        try (Session session = sessionFactory.getCurrentSession()) {
            ...
            film.setReplacementCost(BigDecimal.valueOf(5.5));
            film.setRentalRate(BigDecimal.valueOf(0));
            film.setLanguage(language);
            film.setDescription("New superhero film");
            film.setTitle("New superhero movie");
            ...
            filmText.setDescription("New superhero film");
            filmText.setTitle("New superhero movie");
    ...
    private void customerRentInventory(Customer customer) {
        try(Session session = sessionFactory.getCurrentSession()) {
            ...
            Film film = filmDAO.getFirstAvailableFimlForRent();
    ...
    private Customer createCustomer() {
        try(Session session = sessionFactory.getCurrentSession()) {
            ...
            address.setAddress("Boulevard Cappuccino, 55");
            ...
            customer.setEmail("anycustomer@gmail.com");
